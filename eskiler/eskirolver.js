module.exports = {
    name: 'eskirolver---kullanilmiyor',
    description: 'fgdhjkhfdsgr.',
    async execute(message) {
        try {
          ...
          message.channel.send("Rol vercem");
            ...
            const membersWithoutRole = message.guild.members.cache.filter(member => !member.roles.cache.has(roleID));
